...
const dict = {
  en: {
    ...
    storyReadPercent: (pct: number) => `Read: ${pct}%`,
    storyMaxDensity: (pct: number) => `Max density: ${pct}%`,
    completionTitle: "Story finished",
    completionDensity: (pct: number) => `Density: ${pct}%`,
    completionTotalWords: (n: number) => `Words in story: ${n}`,
    completionSeen: (n: number) => `Encountered: ${n}`,
    completionAdded: (n: number) => `Added to vocabulary: ${n}`,
    completionRaiseDensity: "Read at higher density",
  ...
  ru: {
    ...
    storyReadPercent: (pct: number) => `Прочитано: ${pct}%`,
    storyMaxDensity: (pct: number) => `Макс. плотность: ${pct}%`,
    completionTitle: "История прочитана",
    completionDensity: (pct: number) => `Плотность: ${pct}%`,
    completionTotalWords: (n: number) => `Слов в истории: ${n}`,
    completionSeen: (n: number) => `Встречено из них: ${n}`,
    completionAdded: (n: number) => `Добавлено в словарь: ${n}`,
    completionRaiseDensity: "Прочитать на большей плотности",
