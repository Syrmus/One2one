...
const dict = {
  en: {
    ...
    statsNavLink: "Analytics",
    statsTitle: "Analytics",
    statsAccessDenied: "Owner only.",
    statsTotalUsers: "Users",
    statsActiveToday: "Active today",
    statsActive7d: "Active (7d)",
    statsReturning: "Returning",
    statsDailyActive: "Daily active (30d)",
    statsPerUser: "Per user",
    statsColUser: "User",
    statsColSignup: "Signup",
  ...
  ru: {
    ...
    statsNavLink: "Аналитика",
    statsTitle: "Аналитика",
    statsAccessDenied: "Только для владельца.",
    statsTotalUsers: "Пользователей",
    statsActiveToday: "Активны сегодня",
    statsActive7d: "Активны (7д)",
    statsReturning: "Возвращаются",
    statsDailyActive: "Активность по дням (30д)",
    statsPerUser: "По пользователям",
    statsColUser: "Пользователь",
    statsColSignup: "Регистрация",
